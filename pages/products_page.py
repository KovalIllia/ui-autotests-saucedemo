...
class ProductsPage(LoginPage):
    ...
    def get_first_order(self):
        expect(self.page.locator(self.locators.SAUCE_LABS_BACKPACK_BUTTON)).to_be_enabled()
    ...
    def get_second_order(self):
        expect(self.page.locator(self.locators.SAUCE_LABS_BIKE_LIGHT_BUTTON)).to_be_enabled()
